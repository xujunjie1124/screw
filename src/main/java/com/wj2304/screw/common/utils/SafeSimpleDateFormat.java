...
public class SafeSimpleDateFormat {
    ...
    private static final String DEFAULTDATEPATTERN = "yyyy-MM-dd'T'HH:mm:ss";
    /** 锁对象 */
     ...
     * @return
     */
    private static SimpleDateFormat getSdf(String datePattern) {
        final String pattern = StringUtils.isBlank(datePattern) ? DEFAULTDATEPATTERN
                : datePattern;
